...
{
    //T is the obj and S is the Value
...
class AllStudents{
    ...
    public void removeStudent(String id){
        int idx = _students.findItem(id, new StudentSearch());
        _students.removeItem(idx);
    }
    public void modifyID(String ID, String NID)
    {
        int idx = findStudent(ID);
        if(idx >= 0 && idx < _students.size())
        {
...
class AllCourses{
    ...
    public void removeCourse(String cnum){
        int idx = _courses.findItem(cnum, new CourseSearch());
        _courses.removeItem(idx);
    }
    public void modifyCnum(String cnum, String ncnum)
    {
        int idx = findCourse(cnum);
        if(idx >= 0 && idx < _courses.size())
        {
